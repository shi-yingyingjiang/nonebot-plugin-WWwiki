...
async def draw_rolecard(draw_data: dict):
    ...
    forms_data_combat = [
        [
            ...
            {},
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[3][0]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[4][0]},
        ], [
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[0][1]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[2][1]},
            {},
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[3][1]},
            {"color": draw_color("群组内容"), "size": 24, "text": combat_data[4][1]},
        ], [
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[0][2]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[2][2]},
            {},
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[3][2]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[4][2]},
        ], [
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[0][3]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[2][3]},
            {},
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[3][3]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[4][3]},
        ], [
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[0][4]},
            {"color": draw_color("群组内容"), "size": 26, "text": combat_data[2][4]},
            {},
            {"color": draw_color("群组名称"), "size": 30, "text": combat_data[3][4]},
